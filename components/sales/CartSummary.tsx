...
export const CartSummary: React.FC<CartSummaryProps> = ({
  ...
  return (
    <View style={styles.container}>
      ...
      {/* M-Pesa phone number field — locked +254 prefix */}
      {isMpesa && (
      ...
      <Button
        title={isMpesa ? 'Send Payment Request' : 'Complete Sale'}
        leftIcon={isMpesa ? 'phone-portrait-outline' : 'checkmark-circle-outline'}
        onPress={onCheckout}
        loading={loading}
        disabled={isMpesa && (!mpesaEnabled || !mpesaReady)}
      />
    </View>
  );
};
