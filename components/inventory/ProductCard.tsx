...
/** Flat row, no shadow — matches the list-row treatment used across the app
 * (CartItem, StaffCard, expense rows). */
...
const styles = StyleSheet.create({
  ...
  price: { fontSize: Typography.size.small, color: Colors.textSecondary, marginTop: 2 },
