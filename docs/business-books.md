...
Smart Duka already captures everything a small business does: sales, purchases, purchase costs,
...
The guiding rule: **the user records business activity; Smart Duka produces the books.**
...
| **What ships first** | Only books that are **100 % derivable from data Smart Duka already captures**. | Six of the sixteen books in the original concept (Trial Balance, Balance Sheet, Cash Flow, Customer Ledger, Supplier Ledger, Tax Summary) have no inputs in the current schema. Shipping an approximated Balance Sheet that a shopkeeper takes to a lender is worse than not shipping one. |
